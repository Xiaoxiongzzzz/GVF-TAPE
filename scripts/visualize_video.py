...
image = Image.open(
    "/mnt/home/ZhangXiaoxiong/Documents/VideoGeneration/results/policy/pick_up_the_black_bowl_between_the_plate_and_the_ramekin_and_place_it_on_the_plate/video3.gif"
)

text_ids = tokenizer(
    task_prompt, return_tensors="pt", padding=True, truncation=True, max_length=128
).to(device)
